@extends('frontend.layouts.main')  <!-- Sesuaikan dengan layout utama Anda -->
@section('title', 'Daftar Atlet Porlempika')
@section('navAtlet', 'active')  <!-- Untuk highlight menu aktif -->
@section('content')
